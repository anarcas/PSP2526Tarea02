...
public class HiloInspector implements Runnable {
    ...
    // Variable auxiliar para cerrar cada socket establecido
    private static final String MENSAJE_DESPEDIDA = "FIN";
    // Variable auxiliar para cerrar la ITV y los hilos inspectores se puedan marchar
 ...
 // E3
            ...
            for (int i = 0; i < pruebas.length; i++) {
                ...
                mensajeOut = String.format("Realice la prueba: %s", pruebas[i]);
 // E4
                pw.println(mensajeOut);
